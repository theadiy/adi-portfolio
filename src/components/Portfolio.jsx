        ...
        <motion.div {...fadeUp(0)} className="grid md:grid-cols-[1.2fr_1fr] gap-10 items-center">
          <div>
            ...
            <div className="mt-6 flex gap-4 text-sm font-mono">
              ...
              <a href="https://github.com/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-emerald-400/30 hover:bg-white/5"><Github className="w-4 h-4"/>github</a>
              <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-emerald-400/30 hover:bg-white/5"><Linkedin className="w-4 h-4"/>linkedin</a>
            </div>
          </div>
